        ...
        <div class="col-md-4 mb-4">
            <div class="card h-100 text-center p-4">
                <div class="card-body">
                    ...
                    <a href="{{ route('travel.index') }}" class="btn btn-sm btn-outline-primary mt-2">Cari Tiket</a>
                </div>
            </div>
        </div>
        <div class="col-md-4 mb-4">
        ...
        <div class="col-md-4 mb-4">
            <div class="card h-100 text-center p-4">
                <div class="card-body">
                    ...
                    <a href="{{ route('tour.index') }}" class="btn btn-sm btn-outline-primary mt-2">Lihat Paket</a>
                </div>
            </div>
        </div>
    </div>
